...
(function () {
    ...
    // ---------- PHONICS KARAOKE ----------
    const phonicsSets = {
        cvc: ["cat", "dog", "sun", "hat", "pig", "bed", "cup", "box", "map", "pen", "bus", "jam", "web", "lip", "rock", "sock", "bug", "yam", "fan", "zip", "mop", "net", "cap", "tan", "jet", "kit", "ham", "pod", "mud", "ram"],
        sent: ["The dog runs.", "I see a red car.", "The fish swims.", "She is happy.", "We play in the park.", "Dad cooks rice.", "The cat jumps up.", "I read a book.", "The sun is warm.", "They sing a song.", "We ride the bus.", "It is raining today.", "Mom plants a seed.", "Sam kicks the ball.", "The frog can hop.", "Birds fly in the sky."],
        rhyme: ["The cat wears a hat.", "The frog sits on a log.", "The mouse is in the house.", "A goat sails a boat.", "A fox hides in a box.", "The bear sits on a chair.", "A bee sits on my knee.", "The snail rides a rail.", "The mule went to school.", "A pig dances a jig."]
    };
    ...
    // ---------- SIGHT-WORD FLASH ----------
    const sightList = ["said", "yacht", "colonel", "enough", "one", "their", "island", "could", "would", "two", "through", "because", "weight", "colonel", "answer", "biscuit", "borough", "people", "beautiful", "laugh", "daughter", "friend", "again", "though", "thought", "height", "busy", "pretty", "choir", "knowledge", "tongue", "minute", "separate", "rhythm", "Wednesday"];
    ...
    $('naming-start').addEventListener('click', async () => {
        ...
        const pool = ['A', 'B', 'C', 'D', 'E', 'F', 'red', 'blue', 'green', 'yellow', 'purple', 'orange', '7', '12', '19', '25', 'dog', 'cat', 'car', 'sun', 'book', 'ball', 'tree', 'train', 'plane', 'shoe', 'milk', 'apple', 'rain', 'cloud'];
    ...
    const soundwordPool = [
        ...
        { sound: 'sh', label: 'sh', picture: '🛳️', answer: 'ship' },
        { sound: 'fr', label: 'fr', picture: '🐸', answer: 'frog' },
        { sound: 'bl', label: 'bl', picture: '🫐', answer: 'blue' },
        { sound: 'tr', label: 'tr', picture: '🚂', answer: 'train' },
        { sound: 'st', label: 'st', picture: '⭐', answer: 'star' },
        { sound: 'gr', label: 'gr', picture: '🍇', answer: 'grape' }
    ];
    $('soundword-start').addEventListener('click', () => {
        ...
        const next = () => {
            ...
            const extras = ['dog', 'car', 'tree', 'ball', 'apple', 'fish', 'plane', 'house', 'chair', 'bread', 'juice', 'train', 'grape', 'ship', 'frog', 'snake', 'star', 'blue', 'monkey', 'cat'];
    ...
    // ---------- WORD PUZZLE BUILDER (drag & drop) ----------
    const puzzleSets = {
        easy: ['cat', 'dog', 'sun', 'hat', 'fish', 'frog', 'ship', 'milk', 'book', 'ball', 'tree', 'star', 'blue', 'train', 'plane'],
        medium: ['house', 'paper', 'friend', 'school', 'basket', 'purple', 'yellow', 'camera', 'planet', 'flower', 'garden', 'window', 'pencil', 'rabbit', 'monkey']
    };
    $('puzzle-start').addEventListener('click', () => {
        const area = $('puzzle-area');
        area.innerHTML = '';
        let score = 0;
        const diff = $('puzzle-diff') ? ($('puzzle-diff').value || 'easy') : 'easy';
    ...
    const blendSets = [
        ...
        { tiles: ['s', 't', 'a', 'r'], answer: 'star' },
        { tiles: ['t', 'r', 'a', 'i', 'n'], answer: 'train' },
        { tiles: ['p', 'l', 'a', 'n', 'e'], answer: 'plane' },
        { tiles: ['g', 'r', 'a', 'p', 'e'], answer: 'grape' },
        { tiles: ['b', 'l', 'u', 'e'], answer: 'blue' }
    ];
    ...
    const readTapSets = [
        ...
        { story: "Kim has a red bag. She puts a book in it.", q: [{ q: "What color is the bag?", opts: ["blue", "red", "green"], a: 1 }, { q: "What does Kim put in the bag?", opts: ["book", "apple", "toy"], a: 0 }] },
        { story: "Ben sees rain. He opens an umbrella.", q: [{ q: "Why does Ben open the umbrella?", opts: ["It is sunny", "It is rainy", "It is windy"], a: 1 }] },
        { story: "A frog sits on a log by the pond.", q: [{ q: "Where does the frog sit?", opts: ["on a chair", "on a log", "on a rock"], a: 1 }] }
    ];
    ...
    const calmSets = [
        ...
        { story: "A bird sits in a nest.", q: [{ q: "Where is the bird?", opts: ["in a nest", "in a box", "in a car"], a: 0 }] },
        { story: "Liam reads a book at night.", q: [{ q: "When does Liam read?", opts: ["at night", "at noon", "in the morning"], a: 0 }] },
        { story: "Maya plants a seed in soil.", q: [{ q: "What does Maya plant?", opts: ["a seed", "a tree", "a flower"], a: 0 }] }
    ];
    ...
    const deepSets = [
        ...
        { word: 'grape', pics: ['🍇', '🍒', '🍎'], correct: 0 },
        { word: 'star', pics: ['⭐', '🌙', '☁️'], correct: 0 },
        { word: 'train', pics: ['🚂', '🚗', '🚲'], correct: 0 },
        { word: 'ship', pics: ['🛳️', '🚁', '🚌'], correct: 0 },
        { word: 'frog', pics: ['🐸', '🐢', '🐍'], correct: 0 }
    ];
    function renderDeep() {
